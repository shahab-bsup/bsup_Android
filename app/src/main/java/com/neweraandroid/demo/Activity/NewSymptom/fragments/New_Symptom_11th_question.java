 ...
 */
public class New_Symptom_11th_question extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate ( R.layout.fragment_new__symptom_11th_question, container, false );
    }

    // TODO: Rename method, update argument and hook method into UI event
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onEleventhQuestion ( uri );
        }
    }
    ...
    public interface OnNewSymptomEleventhQuestionListener {
        ...
        void onEleventhQuestion(Uri uri);
    }
}
