...
public class NS_2nd_question extends Fragment implements
    ...
    private void dbOperation(final View view) {
        ...
        mMedlynkViewModel.getAnswers ( manager.getAppointmentID (), Constants.NEW_SYMPTOM_ROW,0, 2 )
    ...
    public void onAnswerSuccess(NewSymptomAnswerResponse response) {
        ...
        if (existsRecord == false)
            mMedlynkViewModel.insertAnswersToDB ( manager.getAppointmentID (), Constants.NEW_SYMPTOM_ROW,0, 2, JC.answersToAnswerJson ( answersForDB ) );
        else
            mMedlynkViewModel.updateAnswersToDB ( manager.getAppointmentID (), Constants.NEW_SYMPTOM_ROW,0, 2, JC.answersToAnswerJson ( answersForDB ) );
