...
public class New_Symptom_15th_question_ViewHolder extends RecyclerView.ViewHolder {

    private ProgressBar progressBar;
    private AppCompatEditText answer;

    public New_Symptom_15th_question_ViewHolder(View itemView) {
        super ( itemView );
        progressBar = itemView.findViewById ( R.id.progress_bar );
        answer = itemView.findViewById ( R.id.new_symptom_fifteen_answer );
    }
