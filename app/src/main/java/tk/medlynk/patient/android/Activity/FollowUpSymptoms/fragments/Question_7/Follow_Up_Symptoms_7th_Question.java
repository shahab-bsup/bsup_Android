 ...
 */
public class Follow_Up_Symptoms_7th_Question extends Fragment implements Follow_Up_Symptoms_7th_Question_ViewHolder.OnFollowUpSeventhQuestionViewsClickListener, OnSeventhFollowUpAnswerListener {
    ...
    public static Follow_Up_Symptoms_7th_Question newInstance(String param1, String param2) {
        Follow_Up_Symptoms_7th_Question fragment = new Follow_Up_Symptoms_7th_Question ();
    ...
    public void onNextClick(Answer answer) {
        ...
        MedlynkRequests.followUpResultSeventhAnswer ( getActivity (),
                manager.getAppointmentID (),
                Follow_Up_Symptoms_7th_Question.this,
                answer);
    }
    ...
    @Override
    public void onSeventhAnswerSuccess(FollowUpResultResponse response) {
        System.out.println ( "Follow_Up_Symptoms_7th_Question.onSeventhAnswerSuccess" );
    ...
    public void onSeventhAnswerFailure() {
        System.out.println ( "Follow_Up_Symptoms_7th_Question.onSeventhAnswerFailure" );
        viewHolder.setProgressBarVisibilityStatus ( View.GONE );
    }
