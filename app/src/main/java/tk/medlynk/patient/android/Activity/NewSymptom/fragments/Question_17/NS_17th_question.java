...
public class NS_17th_question extends Fragment implements
    ...
    private void dbOperation(final View view) {
        ...
        medlynkViewModel.getAnswers(manager.getAppointmentID(), Constants.NEW_SYMPTOM_ROW, 0, 17)
                .observe(NS_17th_question.this, new Observer<DataBaseModel>() {
    ...
    public void onNextClicked(List<Answer> answer) {
        ...
        MedlynkRequests.newSymptomQuestionsAnswer(getActivity(), NS_17th_question.this,
                manager.getAppointmentID(),"17", answer);
