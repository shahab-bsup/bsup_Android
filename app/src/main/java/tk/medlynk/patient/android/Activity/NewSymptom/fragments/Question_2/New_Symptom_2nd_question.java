...
public class New_Symptom_2nd_question extends Fragment implements
    New_Symptom_2nd_question_ViewHolder.On2QuestionViewsClickListener,
        OnSecondAnswerListener
{
    ...
    private New_Symptom_2nd_question_ViewHolder viewHolder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewHolder = new New_Symptom_2nd_question_ViewHolder ( view );
    ...
    public void onNextClicked(Answer answer) {
        System.out.println ( "New_Symptom_2nd_question.onNextClicked" );
        viewHolder.setProgressBarVisibilityStatus ( View.VISIBLE );
        SharedPreferenceManager manager = new SharedPreferenceManager ( getActivity () );
        MedlynkRequests.newSymptomSecondQuestionAnswer ( getActivity (),
                New_Symptom_2nd_question.this,
    ...
    public void onSkipClicked() {
        System.out.println ( "New_Symptom_2nd_question.onSkipClicked" );
        mListener.onSecondQuestion ();
    }
